    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 relative overflow-hidden font-sans">
            ...
            <div className="absolute inset-0 pointer-events-none flex justify-center items-center overflow-hidden">
                <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-[800px] h-[800px] bg-indigo-100 rounded-full blur-[100px] opacity-40 animate-pulse" />
                <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-cyan-100 rounded-full blur-[100px] opacity-40" />
            </div>
            ...
            <div className="w-full max-w-lg relative z-10">
                ...
                <div className="text-center mb-10">
                    <h1 className="text-4xl md:text-5xl font-serif text-slate-800 font-medium mb-3 tracking-tight">Welcome back</h1>
                    <p className="text-slate-500 font-medium text-lg">Sign in to your collaborative workspace</p>
                </div>
